    ...
    const fetchAssignmentDetails = async () => {
      try {
        ...
        const response = await fetch(
          `//134.209.110.162:8000/student/assignment/${assignment_id}`,
          {
            method: "GET",
            headers: {
  ...
  const handleSubmitAssignment = async () => {
    ...
    try {
      ...
      const endpoint = assignment?.submission?.id 
        ? `//134.209.110.162:8000/student/assignment/${assignment_id}/update-submission`
        : `//134.209.110.162:8000/student/assignment/${assignment_id}/submit`;
